...
className="flex-[0.5px] lg:max-w-[370px] flex justify-end flex-col gradient-05
...
<div>
  ...
  sm:leading-[22px] leading:[16px] text-white"> Founder | Metaverse</p>
</div>
<p className="mt-[24px] font-normal sm:text-[24px] text-[18px] 
  sm:leading-[45px] leading:[16px] text-white">
  "With the development of today's technology,
  metaverse is very useful for today's work,
  or can be called web 3.0 by using metaverse you
